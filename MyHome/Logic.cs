...
namespace MyHome
{
    public class Logic
    {
        ...
        {
            // TODO: create autogenerated path for saved Qr code. This is just for testing purposes
            var qrCodePayload = new QRCoder.PayloadGenerator.Url($"https://localhost:7211/mobileDeviceInfo/{userID}/{deviceID}");
